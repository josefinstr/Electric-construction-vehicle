...
import_bat = Line2D([0], [0], label='Imported Hydrogen', color='black', linestyle='--',linewidth=linewidth)
...
plt.legend(handles=[storage_cap,import_bat,grid1,grid2,grid3],ncol=3,loc='upper center')
